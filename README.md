...
JavaScript XML(JSX), used for HTML markup code directly in javascript.
 - What is the difference between State and Props?
State used inside the component and props pass outside component
 - What is the useState hook, and how does it work?
usestate Hook takes a initial value as state arguments.
 - How can you share state between components in React?
 Share state between components in React using lifting state up, to closest common parent then pass it to props. 
 - How is event handling done in React?
Pass a function reference to ensure it only run when event occur.
---
